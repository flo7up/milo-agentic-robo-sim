...
export function robotOutcome(state: LiveState, connected: boolean) {
  ...
  if (!connected) {
    ...
    const labels: Record<string, [string, string]> = {
      ...
      limited: ['warning', 'Task limit reached'], interrupted: ['stopped', 'Stopped'],
...
export function OutcomeFeedback({ state, connected }: { state: LiveState; connected: boolean }) {
  const outcome = robotOutcome(state, connected);
