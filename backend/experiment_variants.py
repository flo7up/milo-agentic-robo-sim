...
ARCHITECTURES = {
    ...
    "unified_mission": ("unified-map-mission", "Unified map-aware mission", "0.4.1"),
    "hybrid_task_supervision": ("qwen-luna-task-supervision", "Qwen with Luna task supervision", "0.3.1"),
