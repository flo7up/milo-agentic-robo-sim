...
**Unified cockpit controls:** one sticky command bar contains power, Start, Stop and the primary robot status. Its options menu contains Reset episode and Enable manual control / Take manual control. Expanded camera, map and challenge dialogs use that same bar. The mission panel contains the goal, token accounting, connection and run settings.
